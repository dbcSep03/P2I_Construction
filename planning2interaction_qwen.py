...
def main():
    ...
    parser.add_argument("--planning_json", type=str, default="plan_0208/Base/res_2/valid_dialogues.json", help="Path to planning JSON file (for from_planning mode)")
    parser.add_argument("--out_dir", type=str, default="plan_0208/gen_2/merged_out")
    ...
    parser.add_argument("--batches_dir", type=str, default="plan_0208/gen_2/batch", help="Directory to store per-batch metadata JSONs")
    parser.add_argument("--dialogues_jsonl", type=str, default="plan_0208/gen_2/merged_dialogues_modified.jsonl", help="Append all dialogues into a single JSONL file")
